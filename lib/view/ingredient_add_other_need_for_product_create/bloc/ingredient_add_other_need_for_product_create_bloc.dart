...
class IngredientAddOtherNeedForProductCreateBloc extends ChangeNotifier {
  /// Bloc state
  ...
  IngredientAddOtherNeedForProductCreateBloc() {
    _showLoading();
  ...
  Future onTapRegister() async {
    if (size != null &&
      ...
      RequestSizeObjectVO sizeOfIngredientVO = RequestSizeObjectVO(
